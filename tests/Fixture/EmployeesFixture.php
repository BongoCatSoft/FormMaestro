...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'formation_ids' => ['type' => 'binary', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'formation_infos' => ['type' => 'binary', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'formation_infos' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-09-11 20:21:10',
                'modified' => '2019-09-11 20:21:10'
            ],
        ];
        parent::init();
    }
